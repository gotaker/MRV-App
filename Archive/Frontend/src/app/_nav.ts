...
export const adminNavItems: NavData[] = [
  ...
  },
  {
    ...
    children: [
      {
        name: "Mitigation Project Action",
        url: "/Mitigation_Actions/ProjectInformation",
        icon: "icon-check",
      },
      {
        name: "Mitigation Monitoring Action",
  ...
  },
  {
    ...
    children: [
      {
        name: "Climate Finance Information",
        url: "/Climate_Finance/ProjectInformation",
        icon: "icon-check",
      },
      {
        name: "Climate Finance Monitoring",
...
export const userNavItems: NavData[] = [
  ...
  },
  {
    ...
    children: [
      {
        name: "Climate Project Information",
        url: "/Climate_Finance/ProjectInformation",
        icon: "icon-check",
      },
      {
        name: "Climate Monitoring Information",
        url: "/Climate_Finance/MonitoringInformation",
        icon: "icon-screen-desktop",
      },
    ],
  },
  {
    ...
    children: [
      {
        name: "SDG Project Information",
        url: "/SDG_Assessment/ProjectInformation",
        icon: "icon-check",
      },
      {
        name: "SDG Monitoring Information",
        url: "/SDG_Assessment/MonitoringInformation",
        icon: "icon-screen-desktop",
      },
    ],
